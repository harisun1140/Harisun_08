...
(24, 49494032, 1, 0, 0.00),
(30, 49494043, 1, 2, 20000.00),
(32, 49494043, 11, 1, 2600.00);
...
(1, 'HARISUN', 'risun', '123', 'Administrator'),
(2, 'KARYAWAN', 'koko', '123', 'Petugas'),
(6, 'haris', 'harisun', '123', 'Petugas');
...
(24319, 'reee', 'sarjana', '08777829'),
(32406, 'reee', 'sarjana', '08777829'),
(33543, 'reee', 'sarjana', '08777829');
...
(49494032, '2024-02-13', 21000.00, 24319, 2),
(49494043, '2024-03-06', 22600.00, 32406, 2),
(49494046, '2024-03-06', 0.00, 33543, 2);
...
--
ALTER TABLE `tb_penjualan`
  MODIFY `id_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49494047;
